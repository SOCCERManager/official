...
public class WedstrijdTest {
   ...
   @Test
    ...
    public void playGameDraw() {
        ...
        Team t58 = new Team(spellijst, "Team3", posities, null, 3333);
        teamlijst.add(t56);
        teamlijst.add(t57);
        Competitie c = new Competitie(wlijst, teamlijst);
        t56.setCompetitie(c);
        t57.setCompetitie(c);
        t58.setCompetitie(c);
        c.bouwWedstrijden();
    ...
    public void getEnSetSpeeldagTest() {
        we.setSpeeldag(1);
        assertTrue(1==we.getSpeeldag());
    }
    
    @Test
    public void playGameOpstellingenNietValideENTeamBWinTest() {
        ArrayList<Speler> spellijst = new ArrayList<Speler>();
    ...
    @Test
    public void playGameUI_TeamAWinTest() {
        ArrayList<Speler> spellijst = new ArrayList<Speler>();
        ArrayList<Speler> slijstB = new ArrayList<>();
        ArrayList<PosPlayer> opstellingB = new ArrayList<PosPlayer>();
        ArrayList<PosPlayer> posities = new ArrayList<PosPlayer>();
    ...
    @Test
    public void playGameMoreRandomValuesTest() {
        ArrayList<Speler> spellijst = new ArrayList<Speler>();
        ArrayList<Speler> slijstB = new ArrayList<>();
        ArrayList<PosPlayer> opstellingB = new ArrayList<PosPlayer>();
        ArrayList<PosPlayer> posities = new ArrayList<PosPlayer>();
        ...
        w1.getTeam_a().getSpelers().get(0).setGamesTilStatusDisapears(2);
        w1.getTeam_b().getSpelers().get(3).setGamesTilStatusDisapears(2);
        soccer.Random.get().setSeed(13);
        w1.playGame();
        assertTrue(w1.getPoints_a() == 0);
    }
    
    @Test
    public void playGameTeamA_ValideOpstellingNiet_UI_Test() {
        ArrayList<Speler> spellijst = new ArrayList<Speler>();
        ArrayList<Speler> slijstB = new ArrayList<>();
        ArrayList<PosPlayer> opstellingB = new ArrayList<PosPlayer>();
        ArrayList<PosPlayer> posities = new ArrayList<PosPlayer>();
        ...
        soccer.Random.get().setSeed(13);
        w1.playGame();
        assertTrue(w1.getPoints_a()==3 || w1.getPoints_a() == 0 || w1.getPoints_a() == 1);
    }
    
    @Test
    public void playGameDrawScore_A_plus2Test() {
        ArrayList<Speler> spellijst = new ArrayList<Speler>();
        ArrayList<Speler> slijstB = new ArrayList<>();
        ArrayList<PosPlayer> opstellingB = new ArrayList<PosPlayer>();
        ArrayList<PosPlayer> posities = new ArrayList<PosPlayer>();
...
//            soccer.Random.get().setSeed(i);
//            if(soccer.Random.get().nextFloat() < 0.05) {
//                System.out.println("GEVONDEN:  " + i);
//            }
//        }
        soccer.Random.get().setSeed(8703);
        w1.playGame();
        System.out.println("UITSLAG: " + w1.getScore_a() + " - " + w1.getScore_b());
        assertTrue(w1.getPoints_a()==3 || w1.getPoints_a() == 0 || w1.getPoints_a() == 1);
    }
}
